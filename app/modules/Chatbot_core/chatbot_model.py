...
class CHATBOT:
    ...
    def Json_tracking(self, user_id: str, prescription_Id: str, data: str) -> user_data_basemodel:
        ...
        return create_base_model(user_id=user_id, prescription_Id=prescription_Id, form_json=medication)
